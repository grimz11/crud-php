<?php 
  ...
  require_once("./components/displayperson.component.php");
  require_once("./db/dbqueryAction/displayPerson.query.php");
  // require_once("./db/dbconnection/connect.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="container">
    ...
    <?php navBar(); ?>
    <h1 class="display-4 mt-2"><span class="text-success">All</span> List</h1>
    <form action="" method="post">
    <button name="btnAdd">Add</button>
    <button name="btnDisplay">Refresh</button>    
      <?php displayPerson(); ?>
    </form>
  </div>
